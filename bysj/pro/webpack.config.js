...
module.exports = {
	entry:{
		...
		'confirm-order': './src/page/confirm-order/index.js',
		'success-order': './src/page/success-order/index.js',
		'my-love': './src/page/my-love/index.js'
	},
	output:{
	...
	plugins:[
		...
		new htmlWebpackPlugin(getHtmlConfig('cart','购物车详情')),
		new htmlWebpackPlugin(getHtmlConfig('confirm-order','确认订单')),
		new htmlWebpackPlugin(getHtmlConfig('success-order','成功提交订单')),
		new htmlWebpackPlugin(getHtmlConfig('my-love','我的收藏')),
